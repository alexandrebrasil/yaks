...
boardsModule.service('Boards', [function() {
	var boards = [
					...
					]},
					{
						name: 'Cervejas',
						lanes: [
						    {name: 'Receitas', cards: [{name: 'Bittervet', description: 'Malte, �gua, l�pulo!'},
						                               {name: 'HoneyWheat', description: 'Malte, malte mel, �gua, l�pulo.'}]},
						    {name: 'Fermenta��o', cards: []},
						    {name: 'Matura��o', cards: []},
						    {name: 'Refermenta��o na garrafa', cards: [{name: 'Bittervet', description: 'Meh...'}]},
